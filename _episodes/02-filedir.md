...
> On Mac it may look like `/Users/nelle`,
...
and Nelle's in `/home/nelle`.  Because Nelle is the current user in our
...
We can also change our location to that directory, so
...
in `/home/nelle/Desktop/data-shell/data`.
If we run `ls` without arguments now,
it lists the contents of `/home/nelle/Desktop/data-shell/data`,
...
> Let's say we are in the `/home/nelle/Desktop/data-shell/` and we type:
>
> ~~~
> $ ls nor
> ~~~
...
>
> > ## Solution
> > We start in the `/home/nelle/protein-data` directory, and create a new folder called `recombine`.
...
> >
> > 1. No, see explanation above.  `proteins-saved.dat` is located at `/home/nelle`
> > 2. Yes
> > 3. No, see explanation above.  `proteins.dat` is located at `/home/nelle/protein-data/recombine`
> > 4. No, see explanation above.  `proteins-saved.dat` is located at `/home/nelle`
> {: .solution}
{: .challenge}
